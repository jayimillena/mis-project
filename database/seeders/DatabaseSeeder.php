    ...
    public function run(): void
    {
        $resources = [
            [
                ...
                'author' => 'Kenneth Huab ( Video Project )',
                'url' => 'CSxkNaE_cX0',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'author' => 'Jubert Artiaga, Mark Dhaniel Cipriano, John Michael Lomerio, Mildred Sarturio ( Video Project )',
                'url' => 'Mx9cJs17paA',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'author' => 'Angelo Dominguiano - Kimberly Anne Bolante - Grace Belludo( Video Project )',
                'url' => '0zUZTuQ04as',
                'updated_at' => now(),
                'created_at' => now(),
            ],
            [
                ...
                'author' => 'Elyssa Espinosa, Ferdinand Perez, Fatima Palima( Video Project )',
                'url' => 'AT7vB1n42eA',
                'updated_at' => now(),
                'created_at' => now(),
            ],
